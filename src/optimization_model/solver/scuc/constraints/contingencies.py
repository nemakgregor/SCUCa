...
def add_constraints(
                ...
                for l_row, alpha_lm in zip(col_rows, col_vals):
                    ...
                    for t in time_periods:
                        ...
                        model.addConstr(
                            ...
                            + float(alpha_lm) * line_flow[out_line.name, t]
            ...
            for gen in cont.units:
                ...
                for l_row, isf_lb in zip(col_rows, col_vals):
                    ...
                    for t in time_periods:
                        ...
                        model.addConstr(
                            line_flow[line_l.name, t] - float(isf_lb) * p_expr
                            <= F_em + cont_over_pos[line_l.name, t],
    ...
    logger.info(
        "Cons(C-120/C-121): line-out=%d (conts_used=%d), gen-out=%d (conts_used=%d); lines=%d, T=%d",
        n_cons_line,
        n_conts_used_line,
        n_cons_gen,
        n_conts_used_gen,
