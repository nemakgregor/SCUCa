...
def attach_lazy_contingency_callback(
    ...
    keep_line_pairs = cfg.keep_line_pairs if cfg.keep_line_pairs is not None else None
    keep_gen_pairs = cfg.keep_gen_pairs if cfg.keep_gen_pairs is not None else None
    allowed_lines = (
        cfg.allowed_monitored_lines
        if cfg.allowed_monitored_lines is not None
        else None
    )
